...
/**
 * A toggle switch UI component built on top of Radix UI Switch primitive.
 * 
 * Supports all props of Radix Switch Root, forwards ref properly,
 * and includes accessible focus and disabled states.
 */
